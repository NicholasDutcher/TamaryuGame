...
public class IslandMenue extends Decoration{
	...
	private void startScroll(){
		ani.scroll();
		/*if(!scrolling){
			//System.out.println("Scroll Head Z: "+ani.getPosition().z+"; Scroll Body Z: "+ani.getButton().getPosition().z);
			if(ani.getScrollPosition() == ani.getScrollMinPos()){
				scrollTarget = ani.getScrollMaxPos();
			}else{
				scrollTarget = ani.getScrollMinPos();
			}
			scrolling = true;
		}*/
	}
